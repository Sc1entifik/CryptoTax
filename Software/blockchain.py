...
class Blockchain():
    other_information_filepath = "./Dict_CSV/"
    pub_wallets_filepath = "./Dict_CSV/PubWallets/"
    blockchain_transactions_filepath = "./Tax/BlockchainTxReports/"
    mining_income_filepath = "./Tax/MiningIncome/"
    cost_basis_filepath = "./Tax/CostBasis/"
